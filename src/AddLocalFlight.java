...
ImagePanel panel = new ImagePanel(new ImageIcon("E:\\New folder\\AirlineFlightManagementSystem\\1563.jpg").getImage());
		...
		lblNewLabel.setBounds(10, 11, 500, 21);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String query = "INSERT into localflights values('"+flightID.getText()+"','"+flightTime.getText()+"','"+landTime.getText()+"','"+departCity.getText()+"','"+landCity.getText()+"',"+economySeats.getText()+","+businessSeats.getText()+","+distance.getText()+")";
				Statement st=null;
				try {

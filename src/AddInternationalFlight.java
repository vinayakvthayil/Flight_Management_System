...
ImagePanel panel = new ImagePanel(new ImageIcon("E:\\New folder\\AirlineFlightManagementSystem\\1123.jpg").getImage());
		...
		lblNewLabel.setBounds(10, 10, 500, 21);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Flight ID");
		lblNewLabel_1.setBounds(20, 36, 101, 21);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
					JOptionPane.showMessageDialog(null, "Business seats cannot be greater than '50'");
				}
				sqlconnect connection = new sqlconnect();
			    Connection con = connection.connect();
				String query = "INSERT into internationalflights values('"+flightID.getText()+"','"+flightTime.getText()+"','"+landTime.getText()+"','"+departCity.getText()+"','"+landCity.getText()+"',"+economySeats.getText()+","+businessSeats.getText()+","+distance.getText()+")";
				Statement st=null;
				try {
				...
				sqlconnect connection_1 = new sqlconnect();
			    Connection con_1 = connection.connect();
			    String query_1 = "DELETE FROM internationalflights WHERE flightID = '" + flightID.getText() + "'";
				Statement st_1=null;
				try {
					st = con.createStatement();
					System.out.println(st.executeUpdate(query));
				...
				internationalFlight obj=new internationalFlight(flightID.getText(),flightTime.getText(),landTime.getText(),departCity.getText(),landCity.getText()

...
ImagePanel panel = new ImagePanel(new ImageIcon("E:\\New folder\\AirlineFlightManagementSystem\\1563.jpg").getImage());

		JLabel lblNewLabel = new JLabel("Edit Flight");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblNewLabel.setForeground(Color.WHITE);
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(70, 11, 414, 20);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else
				{
				    ...
				    String query = "UPDATE localflights set flightID = '"+flightID.getText()+"', time = '"+flightTime.getText()+"', departureCity = '"+departCity.getText()+"', landingCity = '"+landCity.getText()+"', economySeats = "+economySeats.getText()+", businessSeats = "+businessSeats.getText()+", timeduration = "+distance.getText()+" WHERE flightID = '"+flightID.getText()+"'";
					Statement st=null;
					try {
